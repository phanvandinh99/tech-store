...
<div class="table-container">
    ...
    <div id="tableContent">
        @include('admin.sanpham.table', ['sanPhams' => $sanPhams])
    </div>
    <div id="paginationContent">
        @include('admin.sanpham.pagination', ['sanPhams' => $sanPhams])
    </div>
</div>
@endsection
...
<script>
    ...
    function loadData() {
        ...
        const url = new URL('{{ route('admin.sanpham.index') }}', window.location.origin);
