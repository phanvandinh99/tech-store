...
<div class="page-header-compact">
    <div class="header-row">
        ...
        <div>
            <a href="{{ route('admin.danhmuc.create') }}" class="btn btn-primary btn-sm">
...
<div class="table-container">
    ...
    <div id="tableContent">
        @include('admin.danhmuc.table', ['danhMucs' => $danhMucs])
    </div>
    <div id="paginationContent">
        @include('admin.danhmuc.pagination', ['danhMucs' => $danhMucs])
    </div>
</div>
@endsection
...
<script>
    ...
    function loadData() {
        ...
        const url = new URL('{{ route('admin.danhmuc.index') }}', window.location.origin);
    ...
    function updateSortIcons() {
        // Reset all icons and remove sort classes
    ...
    // Handle column header clicks (delegation)
