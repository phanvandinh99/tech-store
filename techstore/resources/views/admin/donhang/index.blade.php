...
<div class="table-container">
    ...
    <div id="tableContent">
        @include('admin.donhang.table', ['donHangs' => $donHangs])
    </div>
    <div id="paginationContent">
        @include('admin.donhang.pagination', ['donHangs' => $donHangs])
    </div>
</div>
@endsection
...
<script>
    ...
    function loadData() {
        ...
        const url = new URL('{{ route('admin.donhang.index') }}', window.location.origin);
